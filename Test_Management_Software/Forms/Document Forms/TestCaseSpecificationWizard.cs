...
{
    public partial class TestCaseSpecificationWizard : Form
    {
        ...
        public TestCaseSpecificationWizard(string name, string description, MainForm parentForm)
        {
            InitializeComponent();
        ...
        public TestCaseSpecificationWizard()
        {
            this.name = "Template";
