...
{
    public partial class TestItemTransmittalReportWizard : Form
    {
        ...
        public TestItemTransmittalReportWizard(string name, string description, MainForm parentForm)
        {
            //put in the designer
        ...
        public TestItemTransmittalReportWizard()
        {
            this.name = "Template";
