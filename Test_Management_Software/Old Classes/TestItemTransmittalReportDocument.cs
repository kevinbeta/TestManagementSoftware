...
{
    class TestItemTransmittalReportDocument : TableLayoutPanel
    {
        Label type;
        Label desc;
        List<String> list;
        public TestItemTransmittalReportDocument(String name, string description, List<String> list2)
            {
                type = new Label();
                desc = new Label();
                this.Name = name;
                ...
                this.AutoSize = true;
                list = list2;
                type.Text = "Test Item Transmittal Report Document";
