...
{
    class TestCaseSpecificationDocument : TableLayoutPanel
    {
        Label type;
        Label desc;
        List<String> list;
        public TestCaseSpecificationDocument(String name, string description, List<String> list2)
        {
            ...
            this.AutoSize = true;
            list = list2;
            type.Text = "Test Case Specification Document";
